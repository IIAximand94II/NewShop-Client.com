              ...
              <div id='carousel-custom' class='carousel slide' data-ride='carousel'>
                <div class='carousel-outer'>
                  ...
                  <div class='carousel-inner '>
                    <div class='item active'>
                      <img src='src/assets/images/shop/single-products/product-1.jpg' alt='' data-zoom-image="images/shop/single-products/product-1.jpg" />
                    </div>
                    <div class='item'>
                    ...
                    <div class='item'>
                      <img src='src/assets/images/shop/single-products/product-3.jpg' alt='' data-zoom-image="images/shop/single-products/product-3.jpg" />
                    </div>
                    <div class='item'>
                      <img src='src/assets/images/shop/single-products/product-4.jpg' alt='' data-zoom-image="images/shop/single-products/product-4.jpg" />
                    </div>
                    <div class='item'>
                      <img src='src/assets/images/shop/single-products/product-5.jpg' alt='' data-zoom-image="images/shop/single-products/product-5.jpg" />
                    </div>
                    <div class='item'>
                      <img src='src/assets/images/shop/single-products/product-6.jpg' alt='' data-zoom-image="images/shop/single-products/product-6.jpg" />
                    </div>
                ...
                <ol class='carousel-indicators mCustomScrollbar meartlab'>
                  <li data-target='#carousel-custom' data-slide-to='0' class='active'>
                    <img src='src/assets/images/shop/single-products/product-1.jpg' alt='' />
                  </li>
                  <li data-target='#carousel-custom' data-slide-to='1'>
                    <img src='src/assets/images/shop/single-products/product-2.jpg' alt='' />
                  </li>
                  <li data-target='#carousel-custom' data-slide-to='2'>
                    <img src='src/assets/images/shop/single-products/product-3.jpg' alt='' />
                  </li>
                  <li data-target='#carousel-custom' data-slide-to='3'>
                    <img src='src/assets/images/shop/single-products/product-4.jpg' alt='' />
                  </li>
                  <li data-target='#carousel-custom' data-slide-to='4'>
                    <img src='src/assets/images/shop/single-products/product-5.jpg' alt='' />
                  </li>
                  <li data-target='#carousel-custom' data-slide-to='5'>
                    <img src='src/assets/images/shop/single-products/product-6.jpg' alt='' />
                  </li>
                    ...
                    <ul class="media-list comments-list m-bot-50 clearlist">
                      ...
                      <li class="media">
                        ...
                        <a class="pull-left" href="#!">
                          <img class="media-object comment-avatar" src="src/assets/images/blog/avater-1.jpg" alt="" width="50" height="50" />
                        </a>
                      ...
                      <li class="media">
                        ...
                        <a class="pull-left" href="#!">
                          <img class="media-object comment-avatar" src="src/assets/images/blog/avater-4.jpg" alt="" width="50" height="50" />
                        </a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="product-item">
              <div class="product-thumb">
                ...
                <img class="img-responsive" src="src/assets/images/shop/products/product-5.jpg" alt="product-img" />
          ...
          <div class="col-md-3">
            <div class="product-item">
              <div class="product-thumb">
                <img class="img-responsive" src="src/assets/images/shop/products/product-1.jpg" alt="product-img" />
                <div class="preview-meta">
                  <ul>
                    <li>
                    <span  data-toggle="modal" data-target="#product-modal">
          ...
          <div class="col-md-3">
            <div class="product-item">
              <div class="product-thumb">
                <img class="img-responsive" src="src/assets/images/shop/products/product-2.jpg" alt="product-img" />
                <div class="preview-meta">
                  <ul>
                    <li>
                    <span  data-toggle="modal" data-target="#product-modal">
          ...
          <div class="col-md-3">
            <div class="product-item">
              <div class="product-thumb">
                <img class="img-responsive" src="src/assets/images/shop/products/product-3.jpg" alt="product-img" />
                <div class="preview-meta">
                  <ul>
                    <li>
                    <span  data-toggle="modal" data-target="#product-modal">
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="modal-image">
                  <img class="img-responsive" src="src/assets/images/shop/products/modal-product.jpg" />
                </div>
              </div>
              <div class="col-md-3">
...
export default {
  ...
  methods:{
      getProduct(){
          this.axios.get('http://127.0.0.1:8000/api/products/1')
          .then(res => {
              console.log(res);
          })
      }
